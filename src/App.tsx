      ...
      <div className="relative h-full flex flex-col justify-between">
        ...
        <div className="relative flex-1 px-3 sm:px-5 pb-4 sm:pb-6 flex items-center justify-center">
          ...
          <div className="pointer-events-none absolute bottom-3 right-4 sm:bottom-4 sm:right-5">
            <div className="pointer-events-auto rounded-2xl border border-white/15 bg-slate-900/80 backdrop-blur-xl px-3 py-2.5 sm:px-3.5 sm:py-3 shadow-[0_18px_45px_rgba(15,23,42,0.9)] space-y-2">
